...
/**
 * Abstract class for enemies that are Crustacean-like
 * Created by: Rvinder Sandhu
 */
export abstract class Crustacean extends RegularEnemy {
    /**
     * Constructor for a Crustacean type regular enemy that utilises a specific intrinsic weapon
    ...
    constructor(
        ...
        this.addCapability(Faction.CRUSTACEAN_FRIENDLY);
    }
}